...
# dataloader
root_path = "D:/user_TruongD/SSD/VOCdevkit/VOC2012"
...
vgg_weights = torch.load("D:/user_TruongD/SSD/weights/vgg16_reducedfc.pth")
...
def train_model(net, dataloader_dict, criterion, optimizer, num_epochs):
    ...
    for epoch in range(num_epochs+1):
        ...
        df.to_csv("D:/user_TruongD/SSD/weights/ssd_logs.csv")
        epoch_train_loss = 0.0
        epoch_val_loss = 0.0
        if ((epoch+1) % 10 == 0):
            torch.save(net.state_dict(), "D:/user_TruongD/SSD/weights/weights/ssd300_" + str(epoch+1) + ".pth")
