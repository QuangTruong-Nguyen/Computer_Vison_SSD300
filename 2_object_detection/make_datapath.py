...
def make_datapath_list(root_path):
    ...
    train_id_names = osp.join(root_path, "D:/user_TruongD/SSD/VOCdevkit/VOC2012/ImageSets/Main/train.txt")
    val_id_names = osp.join(root_path, "D:/user_TruongD/SSD/VOCdevkit/VOC2012/ImageSets/Main/val.txt")
